...
long ppa_dev_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	switch ( cmd ) {
		...
		case PPA_MEM_SET_PORT_TRUNKING: {
			if (!capable(CAP_NET_ADMIN))
				goto EXIT_EFAULT;
#if IS_ENABLED(CONFIG_SOC_GRX500)
			*((unsigned int *)(0xB6080120)) = 0x800;
			wmb();
			*((unsigned int *)(0xBC003C1C)) = 0x7C;
			wmb();
			*((unsigned int *)(0xBA003D10)) = 0x1806;
			wmb();
			*((unsigned int *)(0xB6080120)) = 0x100800;
			wmb();
			*((unsigned int *)(0xB6000010)) = 0x80000000;
			wmb();
			*((unsigned int *)(0xB6000010)) = 0x0;
			wmb();
#endif
			break;
		}
